...
import taesu.faster.coop.cooperation.token.exception.TokenExpirationException;
import taesu.faster.coop.cooperation.token.exception.TokenIssuerNotEqualException;
import taesu.faster.coop.cooperation.token.handler.TokenHandler;
import taesu.faster.coop.cooperation.user.model.User;
import taesu.faster.coop.cooperation.user.model.UserTokenType;
...
public class AccessTokenHandlerImpl implements TokenHandler<User, UserTokenType> {
    ...
    private static final long DEFAULT_EXPIRATION_DURATION;
    ...
    static {
        ...
        DEFAULT_EXPIRATION_DURATION = 10L;
    ...
    public String generateTokenValue(User source, UserTokenType tokenType) {
        ZonedDateTime expirationTime
                = ZonedDateTime.now(ZoneOffset.UTC).plusHours(DEFAULT_EXPIRATION_DURATION);
